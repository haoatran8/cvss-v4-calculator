...
const app = Vue.createApp({
    ...
    methods: {
        ...
        businessImpactClass(businessImpactSeverity) {
          if(businessImpactSeverity == "Low") {
            return "c-hand text-success"
          }
          else if(businessImpactSeverity == "Medium") {
            return "c-hand text-warning"
          }
          else if(businessImpactSeverity == "High") {
            return "c-hand text-error"
          }
          else if(businessImpactSeverity == "Critical") {
            return "c-hand text-error text-bold"
          }
          else {
            return "c-hand text-gray"
    ...
    computed: {
        ...
        businessImpactFactor() {
          ...
          // const total = (this.financialDamage + this.reputationDamage + this.nonCompliance + this.privacy)/4;
          // return total.toFixed(1);
          const total = 
                parseFloat(this.financialDamage) +
                parseFloat(this.reputationDamage) +
                parseFloat(this.nonCompliance) +
                parseFloat(this.privacy);
          return (total/4).toFixed(1);
        },

        businessImpactSeverity() {
          if(this.businessImpactFactor == 0) {
            return "None"
          }
          else if(this.businessImpactFactor < 4.0) {
            return "Low"
          }
          else if(this.businessImpactFactor < 7.0) {
            return "Medium"
          }
          else if(this.businessImpactFactor < 9.0) {
            return "High"
          }
          else {
            return "Critical"
        ...
        overallSeverity() {
          const cvssSeverity = this.qualScore;
          const bifSeverity = this.businessImpactSeverity;
          ...
          if (cvssSeverity in severityMapping && bifSeverity in severityMapping) {
            return severityMapping[cvssSeverity] === "Critical" && severityMapping[bifSeverity] === "Critcal" ? "Critical"
            : severityMapping[cvssSeverity] === "Critical" && severityMapping[bifSeverity] === "High" ? "Critical"
            : severityMapping[cvssSeverity] === "Critical" && severityMapping[bifSeverity] === "Medium" ? "High"
            : severityMapping[cvssSeverity] === "Critical" && severityMapping[bifSeverity] === "Low" ? "Medium"
            : severityMapping[cvssSeverity] === "High" && severityMapping[bifSeverity] === "Critical" ? "Critical"
            : severityMapping[cvssSeverity] === "High" && severityMapping[bifSeverity] === "High" ? "High"
            : severityMapping[cvssSeverity] === "High" && severityMapping[bifSeverity] === "Medium" ? "High"
            : severityMapping[cvssSeverity] === "High" && severityMapping[bifSeverity] === "Low" ? "Medium"
            : severityMapping[cvssSeverity] === "Medium" && severityMapping[bifSeverity] === "Critical" ? "High"
            : severityMapping[cvssSeverity] === "Medium" && severityMapping[bifSeverity] === "High" ? "High"
            : severityMapping[cvssSeverity] === "Medium" && severityMapping[bifSeverity] === "Medium" ? "Medium"
            : severityMapping[cvssSeverity] === "Medium" && severityMapping[bifSeverity] === "Low" ? "Low"
            : severityMapping[cvssSeverity] === "Low" && severityMapping[bifSeverity] === "Low" ? "Low"
            : severityMapping[cvssSeverity] === "Low" && severityMapping[bifSeverity] === "Medium" ? "Low"
            : severityMapping[cvssSeverity] === "Low" && severityMapping[bifSeverity] === "Critical" ? "Medium"
            : severityMapping[cvssSeverity] === "Low" && severityMapping[bifSeverity] === "High" ? "Medium"
            : "None";
          } else {
            if (severityMapping[cvssSeverity] === "Critical")
              return "Critical";
            else if (severityMapping[cvssSeverity] === "High") {
              return "High";
            }
            else if (severityMapping[cvssSeverity] === "Medium") {
              return "Medium";
            }
            else if (severityMapping[cvssSeverity] === "Low") {
              return "Low";
            }
          }
        }
